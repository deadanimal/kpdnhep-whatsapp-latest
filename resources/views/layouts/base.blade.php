...
<head>
    ...
    <link href="{{ asset('css-sass/dashboardEcommerce.css')}}" rel="stylesheet" type="text/css" id="light-style" />
    ...
    <!-- <link href="../css-sass/app-dark.css" rel="stylesheet" type="text/css" id="dark-style" /> -->
...
<body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":true,"darkMode":false, "showRightSidebarOnStart": true}'>
    <div class="wrapper">
        <div data-bs-toggle="collapse" class="leftside-menu">
